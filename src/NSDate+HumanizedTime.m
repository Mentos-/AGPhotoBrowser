...
- (NSString *) stringWithHumanizedTimeDifference:(NSDateHumanizedType) humanizedType withFullString:(BOOL) fullStrings
{
    ...
    weekString   = [NSString stringWithFormat:@"%d%@", weeksDiff, NSLocalizedStringFromTableInBundle(@"WeekKey", translation_table, bundle, @"")];
    dayString    = [NSString stringWithFormat:@"%d%@", daysDiff, NSLocalizedStringFromTableInBundle(@"DayKey", translation_table, bundle, @"")];
    hourString   = [NSString stringWithFormat:@"%d%@", hoursDiff, NSLocalizedStringFromTableInBundle(@"HourKey", translation_table, bundle, @"")];
    minuteString = [NSString stringWithFormat:@"%d%@", minutesDiff, NSLocalizedStringFromTableInBundle(@"MinuteKey", translation_table, bundle, @"")];
    secondString = [NSString stringWithFormat:@"%d%@", secondsDiff, NSLocalizedStringFromTableInBundle(@"SecondKey", translation_table, bundle, @"")];
    ...
    full_weekString   = [NSString stringWithFormat:@"%d %@%@", weeksDiff,
                         NSLocalizedStringFromTableInBundle(@"WeekKey", translation_table,bundle, @""),
                         (weeksDiff == 1) ? @"" : @"s"];
    full_dayString    = [NSString stringWithFormat:@"%d %@%@", daysDiff,
                         NSLocalizedStringFromTableInBundle(@"DayKey", translation_table,bundle, @""),
                         (daysDiff == 1) ? @"" : @"s"];
    full_hourString   = [NSString stringWithFormat:@"%d %@%@", hoursDiff,
                         NSLocalizedStringFromTableInBundle(@"HourKey", translation_table,bundle, @""),
                         (hoursDiff == 1) ? @"" : @"s"];
    full_minuteString = [NSString stringWithFormat:@"%d %@%@", minutesDiff,
                         NSLocalizedStringFromTableInBundle(@"MinuteKey", translation_table,bundle, @""),
                         (minutesDiff == 1) ? @"" : @"s"];
    full_secondString = [NSString stringWithFormat:@"%d %@%@", secondsDiff,
                         NSLocalizedStringFromTableInBundle(@"SecondKey", translation_table,bundle, @""),
                         (secondsDiff == 1) ? @"" : @"s"];
